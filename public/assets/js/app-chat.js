    ...
    (function () {
        ...
        if (searchInput) {
            searchInput.addEventListener("keyup", (e) => {
                ...
                // console.log(searchChatListItems)
                // console.log(searchContactListItems)
        ...
        function searchChatContacts(
            ...
            searchListItems.forEach((searchListItem) => {
                var contact_name = '*';
                var a = searchListItem.querySelector(".align-items-center");
                if (a != null) {
                    var b = a.querySelector(".chat-contact-info");
                    if (b != null) {
                        var contact_name =
                            b.querySelector(".chat-contact-name").textContent;
                    }
                }
                ...
                if (searchValue) {
                    if (
                        -1 < searchListItemText.indexOf(searchValue) ||
                        contact_name.includes(searchValue)
                    ) {
