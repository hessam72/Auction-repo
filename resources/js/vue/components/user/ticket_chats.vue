<template>
    <section class="msger">
        ...
        <main class="msger-chat">
            ...
            >
                ...
                <div class="msg-bubble">
                    <div
                        :class="[
                            item.status != 100 ? 'right-dir' : '',
                            'msg-info',
                        ]"
                    >
                        <div v-if="item.status === 100" class="msg-info-name">
                            Admin
                        </div>
                        <div v-else class="msg-info-name">
                            {{ user.username }}
                        </div>
                        <div class="msg-info-time">
                            ...
                            <p>{{ convertDBTimeToTime(item.created_at) }}</p>
                            <p>{{ convertDBTimeToDate(item.created_at) }}</p>
                        </div>
                    </div>
        ...
        <v-form @submit.prevent="sendMsg" class="chat-input-area">
            <v-row no-gutters>
                <!-- Text Input Field -->
            ...
            <!-- File Upload Input -->
            <v-row style="direction: rtl" no-gutters>
                <v-col cols="12" md="6">
                    <v-file-input
...
export default {
    ...
    methods: {
        ...
        sendMsg() {
            this.$emit("storeMsg", this.content, this.inputFile, true);
            this.content = null;
            this.inputFile = null;
        },
        close() {
        ...
        downloadFile(file_url) {
            window.open("/storage/" + file_url, "_blank");
        },
    },
    mounted() {},
    props: {
...
.msger-chat {
    ...
    background-image: url("/assets/img/backgrounds/chat-bg.svg");
