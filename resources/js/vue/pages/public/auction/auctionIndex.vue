<template>
    ...
    <div class="index-container flex">
        <div class="main-section">
            ...
            <div class="auction-users-container flex">
                ...
                <div class="participaints flex flex-col">
                            ...
                            <table class="w-full" border="0">
                                ...
                                <tr>
                                    <div class="size">
                                        <div class="pic-container">
                                            <div class="border-wrap">
                                                <img class="user_img" :src="'/storage/images/user_profiles/150-4.jpg'" />
                                            </div>
                                        </div>
                                        <div class="winner-info">
                                            <h3>Flora timony</h3>
                                ...
                                <tr>
                                    <div class="size">
                                        <div class="pic-container">
                                            <div class="border-wrap">
                                                <img class="user_img" :src="'/storage/images/user_profiles/150-8.jpg'" />
                                            </div>
                                        </div>
                                        <div class="winner-info">
                                            <h3>Flora timony</h3>
                                ...
                                <tr>
                                    <div class="size">
                                        <div class="pic-container">
                                            <div class="border-wrap">
                                                <img class="user_img" :src="'/storage/images/user_profiles/150-1.jpg'" />
                                            </div>
                                        </div>
                                        <div class="winner-info">
                                            <h3>Flora timony</h3>
                                ...
                                <tr>
                                    <div class="size">
                                        <div class="pic-container">
                                            <div class="border-wrap">
                                                <img class="user_img" :src="'/storage/images/user_profiles/150-3.jpg'" />
                                            </div>
                                        </div>
                                        <div class="winner-info">
                                            <h3>Flora timony</h3>
                                ...
                                <tr>
                                    <div class="size">
                                        <div class="pic-container">
                                            <div class="border-wrap">
                                                <img class="user_img" :src="'/storage/images/user_profiles/150-10.jpg'" />
                                            </div>
                                        </div>
                                        <div class="winner-info">
                                            <h3>Flora timony</h3>
